...
<head>
	<?php
		...
		//Alvin Enrique Barrantes Alvarado Oblig
	?>
</head>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
								<fieldset>
									...
									<div>
										// se valida el tipo de separador
									<label>seleccione un caracter para separar los datos</label>
										<input type="radio" name="caracter" value=";"> ;
           			 					<input type="radio" name="caracter" value=":"> :
            							<input type="radio" name="caracter" value="\"> \
										<input type="radio" name="caracter" value="|"> |
										<input type="radio" name="caracter" value="&"> &
									...
									<div>
										// se valida si tiene encabezado
									<label>Su archivo tiene encabezado?</label>
										<input type="radio" name="yn" value="Y"> si
